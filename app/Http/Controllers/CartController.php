...
{
    if (!Auth::check()) {
        return response()->json(['status' => 'error', 'message' => 'Bạn cần đăng nhập để cập nhật giỏ hàng.']);
    }
    ...
    if ($request->quantity > $availableStock) {
        return response()->json(['status' => 'error', 'message' => 'Số lượng yêu cầu đã vượt quá tồn kho!']);
    }
    ...
    return response()->json(['status' => 'success', 'message' => 'Cập nhật số lượng thành công!']);
}
